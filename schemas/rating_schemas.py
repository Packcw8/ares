...
def verify_rating(
    ...
    # Optional: add an `is_admin` field to User and check it here
    ...
    # Apply impact on entity’s reputation_score
    avg_score = sum([
    ...
    deduction = (10 - avg_score) * 2  # Higher rating = smaller penalty
